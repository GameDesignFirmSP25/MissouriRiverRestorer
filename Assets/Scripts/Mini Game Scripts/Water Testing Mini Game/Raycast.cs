...
public class Raycast : MonoBehaviour
{
    ...
    void AluminumCanClicked()
    {
        ...
        if (!WaterTestingManager.aPanelIsActive)
        {
            ...
            waterTestingManagerScript.PlayTrashClickedSound(); // Call the PlayTrashClickedSound method from WaterTestingManager
        }
    }
    ...
    void FishClicked()
    {
        ...
        if (!WaterTestingManager.aPanelIsActive)
        {
            ...
            waterTestingManagerScript.PlayFishClickedSound(); // Call the PlayFishClickedSound method from WaterTestingManager
        }
    }
    ...
    void MammalClicked()
    {
        ...
        if (!WaterTestingManager.aPanelIsActive)
        {
            ...
            waterTestingManagerScript.PlayMammalClickedSound(); // Call the PlayMammalClickedSound method from WaterTestingManager
        }
    }
    ...
    void RiverbankClicked()
    {
        ...
        if (!WaterTestingManager.aPanelIsActive)
        {
            ...
            waterTestingManagerScript.PlayRiverbankClickedSound(); // Call the PlayRiverbankClickedSound method from WaterTestingManager
        }
    }
