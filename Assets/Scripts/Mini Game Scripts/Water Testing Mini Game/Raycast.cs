        ...
        if (isClickable)
        {
            ...
            if (Input.GetMouseButtonDown(0))
            {
                ...
                if (Physics.Raycast(ray, out hit))
                {
                    ...
                    // Check if the clicked object has the "Trash: can" tag & bool effectsOfAluminumPanelActive is false
                    if (hit.collider.CompareTag("Trash: can") && !WaterTestingManager.effectsOfAluminumPanelActive)
                    {
                    ...
                    // Check if the clicked object has the "Trash: tire" tag & bool effectsOfTirePanelActive is false
                    if (hit.collider.CompareTag("Trash: tire") && !WaterTestingManager.effectsOfTirePanelActive)
                    {
                    ...
                    // Check if the clicked object has the "Trash: gas can" tag & bool effectsOfGasPanelActive is false
                    if (hit.collider.CompareTag("Trash: gas can") && !WaterTestingManager.effectsOfGasPanelActive)
                    {
                    ...
                    // Check if the clicked object has the "Trash: trash bag" tag & bool effectsOfTrashPanelActive is false
                    if (hit.collider.CompareTag("Trash: trash bag") && !WaterTestingManager.effectsOfTrashPanelActive)
                    {
