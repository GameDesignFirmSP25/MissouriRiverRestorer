...
public class TypewriterUi : MonoBehaviour
{
    ...
    private float timeBtwChars = 0.025f;

    [SerializeField] string leadingChar = "";
    [SerializeField] bool leadingCharBeforeDelay = false;

    private bool isTyping = false; // Tracks if typing is in progress
    public static bool isTypingComplete = false; // Tracks if typing is complete
    ...
    public SFXMaker skipButton; // Reference to the SFXMaker for playing sound effects

    // Use this for initialization
    void Start()
    {
        isTypingComplete = false; // Reset typing complete state at the start
    ...
    public void PlaySkipTypingSound()
    {
        skipButton.PlaySound();
    }
